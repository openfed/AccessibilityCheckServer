...
export class ApiService {
  ...
  private socketMessages: Subject<{
    type: string;
    payload: any;
  }> = new Subject<{ type: string; payload: any }>();
  ...
  public getSniffResults(url: string): Observable<SniffResult> {
    ...
    return this.getAllSniffResults().pipe(
  ...
  public getSniffError(url: string): Observable<SniffError> {
    return this.createObservableFromEventType("sniff-error").pipe(
